...
class Graph {
    ...
    public ArrayList<Integer> bfs(int s, int t) {
        ...
        while (!fila.isEmpty()) {
            ...
            if (u == t) {
                // Construindo novamente o caminho a partir do vértice de destino
                int v = t;
                while (v != -1) {
                    caminho.add(v);
                    v = pai[v];
        ...
        // Mostrando que não tem caminho entre s e t
        return null;
    }
}
public class Grafos_ED {
    ...
    public static void main(String[] args) throws FileNotFoundException {
      ...
      //Exibindo qual o arquivo que está sendo lido:
      ...
      // Usando a função de busca em profundidade:        
